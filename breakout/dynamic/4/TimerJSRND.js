...
TimerJSRND.prototype.build = function(session) {
	...
	TimerJS_SoftTimer_default.to(null).when((timer_start) => {
		...
		setTimeout(() => this.bus.emit('timer?timer_timeout', 0x3A, 0xBF, timer_start.id), 0);
	});
...
TimerJSRND.prototype.startTimer = function(TimerJS_startTimer_id_var, TimerJS_startTimer_delay_var) {
	...
	setTimeout(() => this.bus.emit('timer?timer_timeout', 0x2A, 0xEA, id_const), 0);
...
TimerJSRND.prototype.receivetimer_startOntimer = function(id, var424, var448, time) {
	this._receive({_port:"timer", _msg:"timer_start", id:id, var424:var424, var448:var448, time:time});
}

TimerJSRND.prototype.receivetimer_cancelOntimer = function(id, var449, var425) {
	this._receive({_port:"timer", _msg:"timer_cancel", id:id, var449:var449, var425:var425});
}
