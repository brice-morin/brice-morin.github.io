...
TimerJSRND.prototype.build = function(session) {
	...
	TimerJS_SoftTimer_default.to(null).when((timer_start) => {
		...
		setTimeout(() => this.bus.emit('timer?timer_timeout', 0x29, 0x7E, timer_start.id), 0);
	});
...
TimerJSRND.prototype.startTimer = function(TimerJS_startTimer_id_var, TimerJS_startTimer_delay_var) {
	...
	setTimeout(() => this.bus.emit('timer?timer_timeout', 0xDE, 0xD8, id_const), 0);
...
TimerJSRND.prototype.receivetimer_startOntimer = function(time, id, var129, var106) {
	this._receive({_port:"timer", _msg:"timer_start", time:time, id:id, var129:var129, var106:var106});
}

TimerJSRND.prototype.receivetimer_cancelOntimer = function(id, var107, var130) {
	this._receive({_port:"timer", _msg:"timer_cancel", id:id, var107:var107, var130:var130});
}
