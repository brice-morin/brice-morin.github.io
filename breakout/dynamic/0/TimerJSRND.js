...
TimerJSRND.prototype.build = function(session) {
	...
	TimerJS_SoftTimer_default.to(null).when((timer_start) => {
		...
		setTimeout(() => this.bus.emit('timer?timer_timeout', 0x65, 0xD3, timer_start.id), 0);
	});
...
TimerJSRND.prototype.startTimer = function(TimerJS_startTimer_id_var, TimerJS_startTimer_delay_var) {
	...
	setTimeout(() => this.bus.emit('timer?timer_timeout', 0x7C, 0x9C, id_const), 0);
...
TimerJSRND.prototype.receivetimer_startOntimer = function(var25, var0, time, id) {
	this._receive({_port:"timer", _msg:"timer_start", var25:var25, var0:var0, time:time, id:id});
}

TimerJSRND.prototype.receivetimer_cancelOntimer = function(var1, id, var23) {
	this._receive({_port:"timer", _msg:"timer_cancel", var1:var1, id:id, var23:var23});
}
