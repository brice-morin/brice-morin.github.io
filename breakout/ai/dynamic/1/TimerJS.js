...
TimerJS.prototype.build = function(session) {
	...
	TimerJS_SoftTimer_default.to(null).when((timer_start) => {
		...
		setTimeout(() => this.bus.emit('timer?timer_timeout', 0x7E, 0x75, timer_start.id), 0);
	});
...
TimerJS.prototype.startTimer = function(TimerJS_startTimer_id_var, TimerJS_startTimer_delay_var) {
	...
	setTimeout(() => this.bus.emit('timer?timer_timeout', 0x37, 0xA6, id_const), 0);
...
TimerJS.prototype.receivetimer_startOntimer = function(time, var106, var130, id) {
	this._receive({_port:"timer", _msg:"timer_start", time:time, var106:var106, var130:var130, id:id});
}

TimerJS.prototype.receivetimer_cancelOntimer = function(id, var131, var107) {
	this._receive({_port:"timer", _msg:"timer_cancel", id:id, var131:var131, var107:var107});
}
