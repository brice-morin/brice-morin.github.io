...
DisplayBrowser.prototype.build = function(session) {
	...
	let Display_SC_Running = new StateJS.State('Running', this._statemachine).entry(() => {
		if(164 < 164) {
		setTimeout(() => this.bus.emit('display?displayReady_', 0x0C), 0);
		
		} else {
		setTimeout(() => this.bus.emit('display?displayReady__bis', 0x03), 0);
		
		}
		if(2 < 28) {
		setTimeout(() => this.bus.emit('display?displayReadyvar13', 0xE3, 0xE9), 0);
		
		} else {
		setTimeout(() => this.bus.emit('display?displayReadyvar13_bis', 0x29, 0xE9), 0);
...
DisplayBrowser.prototype.initDisplay = function(DisplayBrowser_initDisplay_xsize_var, DisplayBrowser_initDisplay_ysize_var) {
	...
	this.bus.emit('YFRAMESIZE=', this.DisplayBrowser_YFRAMESIZE_var);
		...
		if(224 < 6) {
		setTimeout(() => this.bus.emit('vctrl?positionvar16', 0xF0, 0x61), 0);
		
		} else {
		setTimeout(() => this.bus.emit('vctrl?positionvar16_bis', 0x33, 0xF0), 0);
		
		}
		if(213 < 115) {
		setTimeout(() => this.bus.emit('vctrl?positionyx', posX, 0, 0x2C), 0);
		
		} else {
		setTimeout(() => this.bus.emit('vctrl?positionyx_bis', posX, 0x58, 0), 0);
		...
		this.clearScreen();
			...
			if(67 < 94) {
			setTimeout(() => this.bus.emit('vctrl?velocityvar15', 0x8D, 0x22), 0);
			
			} else {
			setTimeout(() => this.bus.emit('vctrl?velocityvar15_bis', 0x1D, 0x8D), 0);
			
			}
			if(147 < 118) {
			setTimeout(() => this.bus.emit('vctrl?velocitydxdy', 0, 0x7A,  -8), 0);
			
			} else {
			setTimeout(() => this.bus.emit('vctrl?velocitydxdy_bis',  -8, 0, 0xCB), 0);
			...
			if(33 < 45) {
			setTimeout(() => this.bus.emit('vctrl?velocityvar15', 0xF2, 0xE0), 0);
			
			} else {
			setTimeout(() => this.bus.emit('vctrl?velocityvar15_bis', 0xCC, 0xF2), 0);
			
			}
			if(10 < 173) {
			setTimeout(() => this.bus.emit('vctrl?velocitydxdy', 0, 0x69, 8), 0);
			
			} else {
			setTimeout(() => this.bus.emit('vctrl?velocitydxdy_bis', 8, 0, 0x95), 0);
			...
			if(211 < 183) {
			setTimeout(() => this.bus.emit('vctrl?velocityvar15', 0xE9, 0x87), 0);
			
			} else {
			setTimeout(() => this.bus.emit('vctrl?velocityvar15_bis', 0x85, 0xE9), 0);
			
			}
			if(147 < 190) {
			setTimeout(() => this.bus.emit('vctrl?velocitydxdy', 0, 0xA2, 0), 0);
			
			} else {
			setTimeout(() => this.bus.emit('vctrl?velocitydxdy_bis', 0, 0, 0x6F), 0);
		...
		if(234 < 237) {
		setTimeout(() => this.bus.emit('vctrl?positionyx', x, 0, 0x29), 0);
		
		} else {
		setTimeout(() => this.bus.emit('vctrl?positionyx_bis', x, 0x4F, 0), 0);
		
		}
		if(185 < 151) {
		setTimeout(() => this.bus.emit('vctrl?positionvar16', 0xEF, 0x3F), 0);
		
		} else {
		setTimeout(() => this.bus.emit('vctrl?positionvar16_bis', 0x44, 0xEF), 0);
...
DisplayBrowser.prototype.receivecreate_Ondisplay = function(var40) {
	this._receive({_port:"display", _msg:"create_", var40:var40});
}

DisplayBrowser.prototype.receivecreatexsizeysizevar10Ondisplay = function(ysize, xsize, var10, var41) {
	this._receive({_port:"display", _msg:"createxsizeysizevar10", ysize:ysize, xsize:xsize, var10:var10, var41:var41});
}

DisplayBrowser.prototype.receivedestroy_Ondisplay = function(var30) {
	this._receive({_port:"display", _msg:"destroy_", var30:var30});
}

DisplayBrowser.prototype.receivedestroyvar11Ondisplay = function(var31, var11) {
	this._receive({_port:"display", _msg:"destroyvar11", var31:var31, var11:var11});
}

DisplayBrowser.prototype.receiveupdate_Ondisplay = function(var34) {
	this._receive({_port:"display", _msg:"update_", var34:var34});
}

DisplayBrowser.prototype.receiveupdatevar12Ondisplay = function(var35, var12) {
	this._receive({_port:"display", _msg:"updatevar12", var35:var35, var12:var12});
}

DisplayBrowser.prototype.receiveclear_Ondisplay = function(var48) {
	this._receive({_port:"display", _msg:"clear_", var48:var48});
}

DisplayBrowser.prototype.receiveclearvar3Ondisplay = function(var3, var49) {
	this._receive({_port:"display", _msg:"clearvar3", var3:var3, var49:var49});
}

DisplayBrowser.prototype.receivesetColorbrvar4Ondisplay = function(b, var4, r, var42) {
	this._receive({_port:"display", _msg:"setColorbrvar4", b:b, var4:var4, r:r, var42:var42});
}

DisplayBrowser.prototype.receivesetColorgOndisplay = function(var43, g) {
	this._receive({_port:"display", _msg:"setColorg", var43:var43, g:g});
}

DisplayBrowser.prototype.receivesetBGColorbOndisplay = function(var28, b) {
	this._receive({_port:"display", _msg:"setBGColorb", var28:var28, b:b});
}

DisplayBrowser.prototype.receivesetBGColorvar5rgOndisplay = function(var5, var29, g, r) {
	this._receive({_port:"display", _msg:"setBGColorvar5rg", var5:var5, var29:var29, g:g, r:r});
}

DisplayBrowser.prototype.receivedrawRectheightOndisplay = function(height, var44) {
	this._receive({_port:"display", _msg:"drawRectheight", height:height, var44:var44});
}

DisplayBrowser.prototype.receivedrawRectyvar6xwidthOndisplay = function(y, x, var6, width, var45) {
	this._receive({_port:"display", _msg:"drawRectyvar6xwidth", y:y, x:x, var6:var6, width:width, var45:var45});
}

DisplayBrowser.prototype.receivefillRectheightxvar7Ondisplay = function(var46, var7, height, x) {
	this._receive({_port:"display", _msg:"fillRectheightxvar7", var46:var46, var7:var7, height:height, x:x});
}

DisplayBrowser.prototype.receivefillRectywidthOndisplay = function(width, y, var47) {
	this._receive({_port:"display", _msg:"fillRectywidth", width:width, y:y, var47:var47});
}

DisplayBrowser.prototype.receivedrawIntegerxOndisplay = function(var36, x) {
	this._receive({_port:"display", _msg:"drawIntegerx", var36:var36, x:x});
}

DisplayBrowser.prototype.receivedrawIntegervdigitsscalevar8yOndisplay = function(digits, y, var8, var37, scale, v) {
	this._receive({_port:"display", _msg:"drawIntegervdigitsscalevar8y", digits:digits, y:y, var8:var8, var37:var37, scale:scale, v:v});
}

DisplayBrowser.prototype.receivedrawThingMLvar9Ondisplay = function(var32, var9) {
	this._receive({_port:"display", _msg:"drawThingMLvar9", var32:var32, var9:var9});
}

DisplayBrowser.prototype.receivedrawThingMLxyOndisplay = function(var33, x, y) {
	this._receive({_port:"display", _msg:"drawThingMLxy", var33:var33, x:x, y:y});
}

DisplayBrowser.prototype.receivecreate__bisOndisplay = function(var64) {
	this._receive({_port:"display", _msg:"create__bis", var64:var64});
}

DisplayBrowser.prototype.receivecreatexsizeysizevar10_bisOndisplay = function(ysize, var10, xsize, var65) {
	this._receive({_port:"display", _msg:"createxsizeysizevar10_bis", ysize:ysize, var10:var10, xsize:xsize, var65:var65});
}

DisplayBrowser.prototype.receivedestroy__bisOndisplay = function(var54) {
	this._receive({_port:"display", _msg:"destroy__bis", var54:var54});
}

DisplayBrowser.prototype.receivedestroyvar11_bisOndisplay = function(var55, var11) {
	this._receive({_port:"display", _msg:"destroyvar11_bis", var55:var55, var11:var11});
}

DisplayBrowser.prototype.receiveupdate__bisOndisplay = function(var58) {
	this._receive({_port:"display", _msg:"update__bis", var58:var58});
}

DisplayBrowser.prototype.receiveupdatevar12_bisOndisplay = function(var12, var59) {
	this._receive({_port:"display", _msg:"updatevar12_bis", var12:var12, var59:var59});
}

DisplayBrowser.prototype.receiveclear__bisOndisplay = function(var72) {
	this._receive({_port:"display", _msg:"clear__bis", var72:var72});
}

DisplayBrowser.prototype.receiveclearvar3_bisOndisplay = function(var73, var3) {
	this._receive({_port:"display", _msg:"clearvar3_bis", var73:var73, var3:var3});
}

DisplayBrowser.prototype.receivesetColorbrvar4_bisOndisplay = function(var66, r, b, var4) {
	this._receive({_port:"display", _msg:"setColorbrvar4_bis", var66:var66, r:r, b:b, var4:var4});
}

DisplayBrowser.prototype.receivesetColorg_bisOndisplay = function(var67, g) {
	this._receive({_port:"display", _msg:"setColorg_bis", var67:var67, g:g});
}

DisplayBrowser.prototype.receivesetBGColorb_bisOndisplay = function(b, var52) {
	this._receive({_port:"display", _msg:"setBGColorb_bis", b:b, var52:var52});
}

DisplayBrowser.prototype.receivesetBGColorvar5rg_bisOndisplay = function(g, r, var5, var53) {
	this._receive({_port:"display", _msg:"setBGColorvar5rg_bis", g:g, r:r, var5:var5, var53:var53});
}

DisplayBrowser.prototype.receivedrawRectheight_bisOndisplay = function(var68, height) {
	this._receive({_port:"display", _msg:"drawRectheight_bis", var68:var68, height:height});
}

DisplayBrowser.prototype.receivedrawRectyvar6xwidth_bisOndisplay = function(width, var6, var69, y, x) {
	this._receive({_port:"display", _msg:"drawRectyvar6xwidth_bis", width:width, var6:var6, var69:var69, y:y, x:x});
}

DisplayBrowser.prototype.receivefillRectheightxvar7_bisOndisplay = function(var7, x, height, var70) {
	this._receive({_port:"display", _msg:"fillRectheightxvar7_bis", var7:var7, x:x, height:height, var70:var70});
}

DisplayBrowser.prototype.receivefillRectywidth_bisOndisplay = function(var71, y, width) {
	this._receive({_port:"display", _msg:"fillRectywidth_bis", var71:var71, y:y, width:width});
}

DisplayBrowser.prototype.receivedrawIntegerx_bisOndisplay = function(x, var60) {
	this._receive({_port:"display", _msg:"drawIntegerx_bis", x:x, var60:var60});
}

DisplayBrowser.prototype.receivedrawIntegervdigitsscalevar8y_bisOndisplay = function(y, var61, scale, v, digits, var8) {
	this._receive({_port:"display", _msg:"drawIntegervdigitsscalevar8y_bis", y:y, var61:var61, scale:scale, v:v, digits:digits, var8:var8});
}

DisplayBrowser.prototype.receivedrawThingMLvar9_bisOndisplay = function(var9, var56) {
	this._receive({_port:"display", _msg:"drawThingMLvar9_bis", var9:var9, var56:var56});
}

DisplayBrowser.prototype.receivedrawThingMLxy_bisOndisplay = function(var57, y, x) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_received_display_destroyvar11_var = function(Display_SC_Running_received_display_destroyvar11_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Wait_received_display_createxsizeysizevar10_var = function(Display_SC_Wait_received_display_createxsizeysizevar10_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_received_display_drawRectyvar6xwidth_var = function(Display_SC_Running_received_display_drawRectyvar6xwidth_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_drawThingML_var9_var = function(Display_SC_Running_display_drawThingML_var9_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_fillRect_var7_var = function(Display_SC_Running_display_fillRect_var7_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_destroy_var11_var = function(Display_SC_Running_display_destroy_var11_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_clear_var3_var = function(Display_SC_Running_display_clear_var3_var) {
	this.Display_SC_Running_display_clear_var3_var = Display_SC_Running_display_clear_var3_var;
}

DisplayBrowser.prototype.initDisplay_SC_Running_received_display_drawIntegervdigitsscalevar8y_var = function(Display_SC_Running_received_display_drawIntegervdigitsscalevar8y_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_received_display_updatevar12_var = function(Display_SC_Running_received_display_updatevar12_var) {
	this.Display_SC_Running_received_display_updatevar12_var = Display_SC_Running_received_display_updatevar12_var;
}

DisplayBrowser.prototype.initDisplay_SC_Running_received_display_drawThingMLvar9_var = function(Display_SC_Running_received_display_drawThingMLvar9_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_received_display_clearvar3_var = function(Display_SC_Running_received_display_clearvar3_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_drawInteger_var8_var = function(Display_SC_Running_display_drawInteger_var8_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_setBGColor_var5_var = function(Display_SC_Running_display_setBGColor_var5_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_received_display_fillRectheightxvar7_var = function(Display_SC_Running_received_display_fillRectheightxvar7_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_update_var12_var = function(Display_SC_Running_display_update_var12_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_display_drawRect_var6_var = function(Display_SC_Running_display_drawRect_var6_var) {
	this.Display_SC_Running_display_drawRect_var6_var = Display_SC_Running_display_drawRect_var6_var;
}

DisplayBrowser.prototype.initDisplay_SC_Running_display_setColor_var4_var = function(Display_SC_Running_display_setColor_var4_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_received_display_setBGColorvar5rg_var = function(Display_SC_Running_received_display_setBGColorvar5rg_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Wait_display_create_var10_var = function(Display_SC_Wait_display_create_var10_var) {
...
DisplayBrowser.prototype.initDisplay_SC_Running_received_display_setColorbrvar4_var = function(Display_SC_Running_received_display_setColorbrvar4_var) {
