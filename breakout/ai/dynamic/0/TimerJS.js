...
TimerJS.prototype.build = function(session) {
	...
	TimerJS_SoftTimer_default.to(null).when((timer_start) => {
		...
		setTimeout(() => this.bus.emit('timer?timer_timeout', 0x65, 0x4E, timer_start.id), 0);
	});
}
TimerJS.prototype.startTimer = function(TimerJS_startTimer_id_var, TimerJS_startTimer_delay_var) {
	...
	setTimeout(() => this.bus.emit('timer?timer_timeout', 0x7C, 0xDA, id_const), 0);
...
TimerJS.prototype.receivetimer_startOntimer = function(var25, id, var0, time) {
	this._receive({_port:"timer", _msg:"timer_start", var25:var25, id:id, var0:var0, time:time});
}

TimerJS.prototype.receivetimer_cancelOntimer = function(var23, var1, id) {
	this._receive({_port:"timer", _msg:"timer_cancel", var23:var23, var1:var1, id:id});
}
