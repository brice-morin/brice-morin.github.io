...
BreakoutGameBrowserRND.prototype.receivetimer_timeoutOnclock = function(id) {
	this._receive({_port:"clock", _msg:"timer_timeout", id:id});
}

BreakoutGameBrowserRND.prototype.receivedisplayReadyOndisplay = function() {
	this._receive({_port:"display", _msg:"displayReady"});
}

BreakoutGameBrowserRND.prototype.receivedisplayErrorOndisplay = function() {
	this._receive({_port:"display", _msg:"displayError"});
}

BreakoutGameBrowserRND.prototype.receivepositionOncontroller = function(x, y) {
	this._receive({_port:"controller", _msg:"position", x:x, y:y});
}

BreakoutGameBrowserRND.prototype.receivelostBallOngame = function() {
	this._receive({_port:"game", _msg:"lostBall"});
}

BreakoutGameBrowserRND.prototype.receivenextLevelOngame = function() {
	this._receive({_port:"game", _msg:"nextLevel"});
}

BreakoutGameBrowserRND.prototype.receivelostBallOnpro_game = function() {
	this._receive({_port:"pro_game", _msg:"lostBall"});
}

BreakoutGameBrowserRND.prototype.receivenextLevelOnpro_game = function() {
