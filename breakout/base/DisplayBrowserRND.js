...
DisplayBrowserRND.prototype.receivecreateOndisplay = function(xsize, ysize) {
	this._receive({_port:"display", _msg:"create", xsize:xsize, ysize:ysize});
}

DisplayBrowserRND.prototype.receivedestroyOndisplay = function() {
	this._receive({_port:"display", _msg:"destroy"});
}

DisplayBrowserRND.prototype.receiveupdateOndisplay = function() {
	this._receive({_port:"display", _msg:"update"});
}

DisplayBrowserRND.prototype.receiveclearOndisplay = function() {
	this._receive({_port:"display", _msg:"clear"});
}

DisplayBrowserRND.prototype.receivesetColorOndisplay = function(r, g, b) {
	this._receive({_port:"display", _msg:"setColor", r:r, g:g, b:b});
}

DisplayBrowserRND.prototype.receivesetBGColorOndisplay = function(r, g, b) {
	this._receive({_port:"display", _msg:"setBGColor", r:r, g:g, b:b});
}

DisplayBrowserRND.prototype.receivedrawRectOndisplay = function(x, y, width, height) {
	this._receive({_port:"display", _msg:"drawRect", x:x, y:y, width:width, height:height});
}

DisplayBrowserRND.prototype.receivefillRectOndisplay = function(x, y, width, height) {
	this._receive({_port:"display", _msg:"fillRect", x:x, y:y, width:width, height:height});
}

DisplayBrowserRND.prototype.receivedrawIntegerOndisplay = function(x, y, v, digits, scale) {
	this._receive({_port:"display", _msg:"drawInteger", x:x, y:y, v:v, digits:digits, scale:scale});
}

DisplayBrowserRND.prototype.receivedrawThingMLOndisplay = function(x, y) {
